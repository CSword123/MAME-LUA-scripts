 ...
 function draw_hud() 
  ...
  elseif game == "kinst2" then
    if mem:readv_u8(0x887FC1B1) ~= 0x00 then
      ...
      s:draw_text(25, 37, "Health: " .. getPlayerDamage("kinst2", 1))
      s:draw_text(25, 45, "Power: " .. getPlayerPower(1))
      s:draw_text(25, 53, "Height: " .. getPlayerHeight("kinst2", 1))
      s:draw_text(25, 61, "Player State: " .. getPlayerState("kinst2", 1))
  
      --kinst2 Player 2 info
      s:draw_box(180, 32, 300, 86,  0xffff0000, 0x80660066)
      s:draw_text(185, 37, "Health: " .. getPlayerDamage("kinst2", 2))
      s:draw_text(185, 45, "Power: " .. getPlayerPower(2))
      s:draw_text(185, 53, "Height: " .. getPlayerHeight("kinst2", 2))
      s:draw_text(185, 61, "Player State: " .. getPlayerState("kinst2", 2))
    end
  end  
end
--[[
