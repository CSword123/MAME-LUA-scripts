...
function tick() 
 ...
 --print("curr Health: " .. updateP2Damage .. " curr Stun: " .. updateP2Stun .. " curr State: " .. updateP2State);
  print(" Combo Hits: " .. mem:read_log_u8(0x8808BC8D) .. " Animation: " .. mem:read_log_u8(0x8808BC14));
end  
...
function getP1Priority(game)
  if game == "kinst" then
    p1Priority = mem:read_log_u8(0x8808BCB8);
  --elseif game == "kinst2" then  
    --p1Priority = mem:read_log_u8();
  end
  return p1Priority;
end
...
function getP2Priority(game)
  if game == "kinst" then
    p2Priority = mem:read_log_u8(0x8808BDB8);
  --elseif game == "kinst2" then  
    --p1Priority = mem:read_log_u8();
  end
  return p2Priority;
 ...
 function draw_hud() 
  if game == "kinst" then
    if mem:read_log_u8(0x8808BD01) ~= 0x00 then
      ...
      --kinst Player 1 info
      s:draw_box(24, 24, 144, 84, 0x80660066, 0xff0000ff)
      ...
      s:draw_text(30, 54, "Trade Priority: " .. getP1Priority("kinst"))
      s:draw_text(30, 62, "Height: " .. getP1Height("kinst"))
      s:draw_text(30, 70, "Player State: " .. getP1State("kinst"))
      
  
      --kinst Player 2 info
      s:draw_box(176, 24, 296, 84, 0x80660066, 0xff0000ff)
      ...
      s:draw_text(182, 54, "Trade Priority: " ..  getP2Priority("kinst"))
