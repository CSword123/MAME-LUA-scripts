...
function tick() 
 ...
 --print("curr Health: " .. updateP2Damage .. " curr Stun: " .. updateP2Stun .. " curr State: " .. updateP2State);
  print("Animation: " .. mem:read_log_u8(0x8808BC14) .. " ???: " .. mem:read_log_u8(0x8808BCC0));
end  
...
function getP1TwoInOne(game)
  ...
  if game == "kinst" then
    if mem:read_log_u8(0x8808BC8D) == 2 then
      isP1TwoInOne = true;
    else
      isP1TwoInOne = false;
    end
...
function getP2TwoInOne(game)
  if game == "kinst" then
    if mem:read_log_u8(0x8808BD8D) == 2 then
      isP2TwoInOne = true;
    else
      isP2TwoInOne = false;
    end
 ...
 function draw_hud() 
  if game == "kinst" then
    if mem:read_log_u8(0x8808BD01) ~= 0x00 then
      ...
      --kinst Player 1 info
      s:draw_box(24, 24, 144, 84, 0x80660066, 0xff000000)
      ...
      --kinst Player 2 info
      s:draw_box(176, 24, 296, 84, 0x80660066, 0xff000000)
